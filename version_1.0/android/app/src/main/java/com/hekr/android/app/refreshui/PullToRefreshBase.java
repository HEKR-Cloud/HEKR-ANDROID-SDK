...
import com.hekr.android.app.refreshui.ILoadingLayout.State;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    public final boolean onInterceptTouchEvent(MotionEvent event) {
        ...
        //如果当前正在刷新并且触发down事件,那么截断事件(自行添加。暂未测试)
        if(isPullRefreshing()){
           return true;
        }
        ...
        case MotionEvent.ACTION_DOWN:
            ...
            //Log.i("MyLog","PullToRefreshBase:onInterceptTouchEvent:mLastMotionY:ACTION_DOWN:"+mLastMotionY);
            //Log.i("MyLog","PullToRefreshBase:onInterceptTouchEvent:mLastMotionX:ACTION_DOWN:"+mLastMotionX);
            mIsHandledTouchEvent = false;
            break;
        ...
        case MotionEvent.ACTION_MOVE:
            ...
            //Log.i("MyLog","PullToRefreshBase:onInterceptTouchEvent:ACTION_MOVE:deltaY:"+deltaY);
            //Log.i("MyLog","PullToRefreshBase:onInterceptTouchEvent:ACTION_MOVE:deltaX:"+deltaX);
            final float absDiff = Math.abs(deltaY);
            //Log.i("MyLog","PullToRefreshBase:onInterceptTouchEvent:垂直方向的变化量:"+absDiff);
            final float absLeft = Math.abs(deltaX);
            //Log.i("MyLog","PullToRefreshBase:onInterceptTouchEvent:水平方向的变化量:"+absLeft);
            // 这里有三个条件：
            ...
            if (absDiff > mTouchSlop || isPullRefreshing() || isPullLoading()){
                ...
                if (isPullRefreshEnabled() && isReadyForPullDown()) {
                    ...
                    mIsHandledTouchEvent = (Math.abs(getScrollYValue()) > 0 || deltaY > 0.3f);
...
//            }
    ...
    public final boolean onTouchEvent(MotionEvent ev) {
        ...
        case MotionEvent.ACTION_DOWN:
            ...
            //Log.i("MyLog","PullToRefreshBase:onTouchEvent:mLastMotionY:"+mLastMotionY);
            //Log.i("MyLog","PullToRefreshBase:onTouchEvent:mLastMotionX:"+mLastMotionX);
            mIsHandledTouchEvent = false;
            break;
            
        case MotionEvent.ACTION_MOVE:
            final float deltaY = ev.getY() - mLastMotionY;
            final float deltaX = ev.getX() - mLastMotionX;
            //Log.i("MyLog","PullToRefreshBase:onTouchEvent:deltaY:"+deltaY);
            //Log.i("MyLog","PullToRefreshBase:onTouchEvent:deltaX:"+deltaX);
            mLastMotionY = ev.getY();
            if (isPullRefreshEnabled() && isReadyForPullDown()) {
